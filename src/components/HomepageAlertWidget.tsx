...
export const HomepageAlertWidget = ({
  ...
  return (
    <Link href={page}>
      <div className="inline-flex items-center px-3 py-1 mb-2 text-sm font-medium text-slate-700 bg-gray-200 bg-opacity-10 rounded-full hover:bg-opacity-20 transition-colors">
